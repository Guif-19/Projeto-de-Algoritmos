...
void criar_diretorios_decrescente() {
...
int* gerar_decrescente(int n, int algoritmo) {
    const char *algoritmos[] = {
        "insertion sort", "bubble sort", "shell sort", 
        "selection sort", "merge sort", "quick sort", "heap sort"
    };
    ...
    snprintf(arq_entrada, sizeof(arq_entrada), "%s/arquivos de entrada/decrescente/%d_decrescente.txt", algoritmos[algoritmo - 1], n);
    snprintf(arq_saida, sizeof(arq_saida), "%s/arquivos de saída/decrescente/%d_ordenado.txt", algoritmos[algoritmo - 1], n);
    snprintf(arq_tempo, sizeof(arq_tempo), "%s/arquivos de tempo/decrescente/tempo_decrescente_%d.txt", algoritmos[algoritmo - 1], n);

    // Gera os números em ordem decrescente e salva no arquivo de entrada
    ...
    printf("Tempo de execução para ordenação decrescente com %d elementos usando %s: %.5lf segundos\n", 
